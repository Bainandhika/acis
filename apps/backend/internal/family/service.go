...
func NewService(repo Repository, db *database.AppDB) Service {
	return &service{
		repo: repo,
		db:   db,
	}
...
func (s *service) CreateFamily(ctx context.Context, userID, name string) (*FamilyDTO, error) {
...
func (s *service) JoinFamily(ctx context.Context, userID, inviteCode string) (*FamilyDTO, error) {
	existing, err := s.repo.FindFamilyByUserID(ctx, userID)
	if err != nil {
		return nil, errors.New("failed to check existing family membership")
	}
...
func (s *service) GetMyFamily(ctx context.Context, userID string) (*FamilyDTO, error) {
...
func (s *service) CreateWallet(ctx context.Context, userID, familyID string, req CreateWalletReq) (*WalletDTO, error) {
...
func (s *service) GetWallets(ctx context.Context, familyID string) ([]WalletDTO, error) {
...
func (s *service) GetWalletBalances(ctx context.Context, familyID string) ([]WalletBalanceDTO, error) {
	wallets, err := s.repo.GetWalletsByFamilyID(ctx, familyID)
	if err != nil {
...
func (s *service) GetLowBalanceWallets(ctx context.Context) ([]LowBalanceWalletDTO, error) {
