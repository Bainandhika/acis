...
type OutboxRepository interface {
	...
	FetchAndLockPending(ctx context.Context, limit int) ([]domain.NotificationJob, error)
...
func (r *outboxRepository) FetchAndLockPending(ctx context.Context, limit int) ([]domain.NotificationJob, error) {
	query := `
